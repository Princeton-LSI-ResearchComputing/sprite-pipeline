...
def main():
    ...
    contacts.ice_raw_contacts(
        raw_contacts_file=args.raw_contacts,
...
def parse_arguments():
    ...
    parser.add_argument(
        "--clusters", metavar="FILE", action="store", help="The input clusters file."
    )
    ...
    parser.add_argument(
        ...
        metavar="FILE",
        action="store",
        help="An intermediate file of raw (un-ICEd) " + "contacts.",
    )
    ...
    parser.add_argument(
        ...
        metavar="FILE",
        action="store",
        help="An intermediate file of biases generated by " + "hicorrector.",
    )
    ...
    parser.add_argument(
        ...
        metavar="ASSEMBLY",
        action="store",
        choices=["mm9", "mm10", "hg19", "hg38", "ci_ht_ky19"],
        default="mm10",
